    ...
    <div className="flex flex-col min-h-screen bg-white text-sm">
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="bg-white shadow-md rounded-lg h-[90vh] w-[1000px] flex flex-col">
            {/* Title */}
            ...
            {/* Scrollable Content */}
            <div className="flex-1 overflow-y-auto p-6 text-gray-700 text-sm leading-relaxed whitespace-pre-line">
